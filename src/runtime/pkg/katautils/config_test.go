...
func TestNewClhHypervisorConfig(t *testing.T) {
	...
	netRateLimiterBwMaxRate := uint64(1000)
	netRateLimiterBwOneTimeBurst := uint64(1000)
	netRateLimiterOpsMaxRate := uint64(0)
	netRateLimiterOpsOneTimeBurst := uint64(1000)
	diskRateLimiterBwMaxRate := uint64(1000)
	diskRateLimiterBwOneTimeBurst := uint64(1000)
	diskRateLimiterOpsMaxRate := uint64(0)
	diskRateLimiterOpsOneTimeBurst := uint64(1000)
